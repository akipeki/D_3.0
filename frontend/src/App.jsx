...
import { logo, logo_SORRY } from './assets';
...
const App = () => {
 ...
 <BrowserRouter>
  ...
  sm:px-8 px-4 py-4 border-b border-b-[#e6ebf4]'>
    <Link to='/'>
<img src={logo_SORRY} alt="logo" className='w-40 object-contain'/>
    </Link>
  ...
  w-full bg-[#f9fafe] min-h-[calc(100vh-73px)]'>
   ...
   <Route path="/" element={<Home />} />
    ...
    <footer className='w-full flex justify-center items-center  bg-[#f9fafe]
  sm:px-8 px-6 py-4 border-b border-b-[#f9fafe]'>
    <Link to='/'>
<img src={logo} alt="logo" className='w-20 object-contain flex justify-center items-center'/>
    </Link>
    </footer>
 </BrowserRouter>
  )
